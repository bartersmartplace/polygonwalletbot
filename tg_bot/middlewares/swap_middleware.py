...
class SwapMiddleware(BaseMiddleware):
    ...
    async def __call__(
        ...
        async with async_session as session:
            ...
            data["swap_presenter"] = SwapPresenter(language=user_language)
            data["swap_view"] = SwapView(bot=self.bot, bot_id=self.bot_id, button_presenter=button_presenter)
